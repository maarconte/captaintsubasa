...
// Project related.
var project                 = 'CaptainTsubasa'; // Project Name.
var projectURL              = 'demarkage.local'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'CaptainTsubasa'; // Your textdomain here.
var translationFile         = 'CaptainTsubasa.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'CaptainTsubasa'; // Package name.
var bugReport               = 'https://AhmadAwais.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'ThatMuch <contact@thatmuch.fr>'; // Last translator Email ID.
var team                    = 'ThatMuch <contact@thatmuch.fr>'; // Team's Email ID.
...
gulp.task('build-copy', function() {
  return gulp.src(build_files)
    .pipe(gulp.dest('dist/CaptainTsubasa'));
});

gulp.task('build-zip', function() {
  return gulp.src('dist/**/*')
    .pipe(zip('CaptainTsubasa.zip'))
    .pipe(gulp.dest('dist'));
});

gulp.task('build-delete', function() {
  del(['dist/**/*', '!dist/CaptainTsubasa.zip']);
});
